namespace MAUIEssentials.Platforms.Android.Helpers
{
    internal class ListBuilder
    {
        ...
        public ListBuilder(int listIndent)
        {
        ...
        private ListBuilder(ListBuilder parent, bool ordered, int listIndent)
        {
            _listIndent = listIndent;
            _parent = parent;
        ...
        public ListBuilder StartList(bool ordered, IEditable output)
        {
            ...
            return new ListBuilder(this, ordered, _listIndent);
        }
