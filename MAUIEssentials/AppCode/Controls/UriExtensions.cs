namespace MAUIEssentials.AppCode.Controls
{
    public static class UriExtensions
    {
        ...
        {
            return uri.Scheme.Equals("tel", StringComparison.OrdinalIgnoreCase);
        }

        public static bool IsSms(this Uri uri)
        {
            return uri.Scheme.Equals("sms", StringComparison.OrdinalIgnoreCase);
        }

        public static bool IsGeo(this Uri uri)
        {
            return uri.Scheme.Equals("geo", StringComparison.OrdinalIgnoreCase);
        }
