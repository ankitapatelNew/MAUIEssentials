...
{
     public class FirebasePushNotificationManager : Java.Lang.Object, IFirebasePushNotification, global::Android.Gms.Tasks.IOnCompleteListener
    {
        ...
        private static ICollection<string> currentTopics = new HashSet<string>(global::Android.App.Application.Context.GetSharedPreferences(KeyGroupName, FileCreationMode.Private).GetStringSet(FirebaseTopicsKey, new Collection<string>()));
        ...
        public static global::Android.Graphics.Color? Color { get; set; }
        ...
        public static void ProcessIntent(Activity activity, Intent intent, bool enableDelayedResponse = true)
        {
            if (intent == null || intent.Extras == null
                || !(intent.Extras.ContainsKey(DefaultPushNotificationHandler.ActionNotificationIdKey)
                || intent.Extras.ContainsKey("collapse_key")))
            {
                return;
            }
            ...
            if (extras != null && !extras.IsEmpty)
            {
                ...
                {
                    var manager = global::Android.App.Application.Context.GetSystemService(Context.NotificationService) as NotificationManager;
        ...
        public static void Initialize(Context context, bool resetToken, bool createDefaultNotificationChannel = true, bool autoRegistration = true)
        {
            ...
            if (autoRegistration)
            {
                ThreadPool.QueueUserWorkItem(state => {
                    var packageInfo = global::Android.App.Application.Context.PackageManager.GetPackageInfo(global::Android.App.Application.Context.PackageName, PackageInfoFlags.MetaData);
                    ...
                    var prefs = global::Android.App.Application.Context.GetSharedPreferences(KeyGroupName, FileCreationMode.Private);
            ...
            if (Build.VERSION.SdkInt >= BuildVersionCodes.O && createDefaultNotificationChannel)
            {
                ...
                global::Android.Net.Uri defaultSoundUri = SoundUri != null ? SoundUri : RingtoneManager.GetDefaultUri(RingtoneType.Notification);
        ...
        public string Token { get { return global::Android.App.Application.Context.GetSharedPreferences(KeyGroupName, FileCreationMode.Private).GetString(FirebaseTokenKey, string.Empty); } }
        ...
        public bool NotificationPermission { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        public void Subscribe(string topic)
        {
            if (!currentTopics.Contains(topic))
            {
                ...
                var editor = global::Android.App.Application.Context.GetSharedPreferences(KeyGroupName, FileCreationMode.Private).Edit();
        ...
        {
            SaveToken(token);
            _onTokenRefresh?.Invoke(CrossFirebaseEssentials.Notifications, new FirebasePushNotificationTokenEventArgs(token, false));
        }
